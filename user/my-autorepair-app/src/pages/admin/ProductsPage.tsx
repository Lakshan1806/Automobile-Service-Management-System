        ...
        <div className="overflow-x-auto">
            ...
            <table className="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Price (LKR)</th>
                ...
                {products.map((product) => (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <button onClick={() => openDeleteModal(product)} className="text-red-600 hover:text-red-900"><TrashIcon className="h-5 w-5"/></button>
                    </td>
                    </tr>
                ))}
                </tbody>
